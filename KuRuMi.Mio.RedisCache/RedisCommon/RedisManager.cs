...
namespace KuRuMi.Mio.DoMain.RedisCache.RedisCommon
{
    public class RedisManager
    {
        ...
        private static readonly Dictionary<ConfigurationOptions, ConnectionMultiplexer> Concache = new Dictionary<ConfigurationOptions, ConnectionMultiplexer>();
        ...
        /// <returns></returns>
        public static ConnectionMultiplexer GetConForMap(ConfigurationOptions options) {
            if (!Concache.ContainsKey(options))
                Concache[options] = GetManager(options);
            return Concache[options];
        }
